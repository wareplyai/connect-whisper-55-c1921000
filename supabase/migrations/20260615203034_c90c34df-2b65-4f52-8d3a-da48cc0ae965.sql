...
RETURNS TABLE(user_id uuid, email text, full_name text, plan text, reply_quota integer, replies_used integer, remaining integer, quota_period_start timestamp with time zone, quota_period_end timestamp with time zone, max_tokens integer)
