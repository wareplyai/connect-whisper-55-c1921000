...
import { LayoutDashboard, Smartphone, CreditCard, BookOpen, HelpCircle, Phone, LogOut, Shield, Receipt, MessageSquareText, Bot, ShieldCheck, MessageSquare, Package, ShoppingBag, ShoppingCart, AlertTriangle } from "lucide-react";
...
const nav = [
  ...
  { to: "/dashboard/mismatches", label: "AI Mismatches", icon: AlertTriangle },
