...
import {
  ...
  ChevronDown, Zap, ToggleRight, SmartphoneCharging, Megaphone,
} from "lucide-react";
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/headadmin/dashboard-ads", label: "Dashboard Ads", icon: Megaphone },
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 h-10 px-3 rounded-md text-sm transition-all border-l-[3px] ${
                        isActive
                          ? "bg-green-500 text-black border-green-600 font-semibold shadow-sm"
